...
const Data = [
  [
    ...
    <p>
      <span className="text-xs">Rs:</span>2,500
    </p>,
    <p>
      <span className="text-xs">Rs:</span>1,500
    </p>,
  ],
  [
    "Gulgasht",
    ...
    <p>
      <span className="text-xs">Rs:</span>2,000
    </p>,
    <p>
      <span className="text-xs">Rs:</span>1,200
    </p>,
  ],
  [
    "Model Town",
    ...
    <p>
      <span className="text-xs">Rs:</span>3,000
    </p>,
    <p>
      <span className="text-xs">Rs:</span>1,800
    </p>,
  ],
  [
    "DHA",
    ...
    6,
    <p>
      <span className="text-xs">Rs:</span>15,000
    </p>,
    <p>
      <span className="text-xs">Rs:</span>3,500
    </p>,
    <p>
      <span className="text-xs">Rs:</span>2,000
    </p>,
...
export default function RouteWiseExpense() {
  const [generateReport, setGenerateReport] = useState(false);
  const handleClose = () => {
    setGenerateReport(false);
  };
  useEffect(() => {
    document.title = "MediRep | Route Wise Expense";
  }, []);
  return (
    <>
