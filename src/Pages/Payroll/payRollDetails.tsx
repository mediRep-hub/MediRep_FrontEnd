...
import Logo from "../../assets/calender copy.svg";
    ...
    <div className="bg-[#F7F7F7] md:h-[calc(100vh-129px)] h-auto rounded-xl p-4">
      <div className="flex flex-wrap items-start justify-between gap-4 max-[564px]:gap-2">
        <div className="flex flex-wrap gap-3 items-center w-full md:w-auto max-[564px]:gap-2">
          ...
          <button className="h-10 flex-1 md:flex-none md:w-[200px] max-[564px] w-full bg-white border border-[#0755E9] rounded-md gap-2 flex justify-center items-center">
        ...
        <button
          ...
          className="h-10 w-full md:w-[200px] text-white bg-[#0755E9] rounded-md gap-3 cursor-pointer flex justify-center items-center"
        >
      ...
      <div
        ...
        className="w-full bg-white rounded-xl border 2xl:h-[calc(72vh-0px)] xl:h-[calc(66.5vh-0px)] overflow-y-auto border-[#0755E9] p-4 mt-3"
      >
        <div
          ref={slipRef}
          ...
          <div className="border border-[#0755E9] h-auto rounded-lg mt-3 p-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <p className="flex items-center text-xs lg:text-sm">
                <span className="text-[#7D7D7D] md:min-w-32.5 min-w-25 mr-2">
                  Employee Name:
                </span>
