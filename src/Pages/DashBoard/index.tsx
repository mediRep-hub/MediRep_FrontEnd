  ...
  return (
    <>
      ...
      <div
        ...
        className={`bg-[#F7F7F7] overflow-x-auto h-auto rounded-xl p-4 
    ${
      birthdayData && birthdayData.length > 0
        ? "2xl:h-[calc(60vh-0px)] xl:h-[calc(40.5vh-0px)]  mt-3 "
        : "2xl:h-[calc(86.6vh-0px)] xl:h-[calc(80vh-0px)] mt-0"
    }`}
      >
        ...
        <div className="flex flex-wrap mt-3 items-stretch md:gap-2 gap-3">
          ...
          {/* <div className="lg:w-[calc(25%-6px)] h-[47vh] w-full bg-[#E5EBF7] rounded-xl p-4">
            ...
            <div
              ...
              className="relative overflow-y-scroll hide-scrollbar h-[calc(43vh-30px)]"
            >
              {[
          ...
          <div className="lg:w-[calc(75%-2px)] w-full">
            ...
            <div className="flex flex-wrap items-stretch gap-2">
              {recent?.map((v: any, index: number) => (
                ...
                >
                  <div className="top-0 left-0 absolute bg-primary w-[10px] h-[165px] rounded-[30px]"></div>{" "}
                  <div className="flex items-center justify-between">
                    <div className="flex gap-2 items-center">
                      <Avatar
                        src={v?.doctor?.image}
                        className="h-10 min-w-10 object-cover rounded-full"
                      />
                    ...
                    <p
                      className={`inline-block rounded-[3px] px-2 font-normal text-sm border ${
                        v?.status === "Pending"
                          ? "text-[#E90761] capitalize border-[#E90761]"
                          : v?.status === "accepted"
                            ? "text-primary capitalize border-primary"
                            : v?.status === "Rejected"
                              ? "text-[#FF9500] capitalize border-[#FF9500]"
                              : v?.status === "Paid"
